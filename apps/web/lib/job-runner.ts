...
@media (prefers-color-scheme: dark) {
  ...
  .card { background: #2a2a3e !important; border-color: #3a3a4e !important; }
}
`);
  ...
  return (
    <main style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem' }}>
      <div className="card" style={{
        ...
        border: '1px solid #e0e0e0', boxShadow: '0 2px 12px rgba(0,0,0,0.08)'
      }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', paddingTop: '1rem', borderTop: '1px solid #e0e0e0' }}>
          <span style={{ display: 'inline-block', width: 8, height: 8, borderRadius: '50%', background: '#22c55e' }}></span>
          <span style={{ fontSize: '0.8rem', opacity: 0.5, color: 'inherit' }}>Generated by AI Workspace</span>
        </div>
      </div>
    </main>
  );
